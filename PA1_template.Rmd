...
The `mean` is define as `rmean` and the `median` is define as `rmedian`.
...
The 5-minute interval, on average across all the days in the data set, containing the maximum number of steps is define as `max_interval`.
